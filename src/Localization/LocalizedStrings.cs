...
public class LocalizedStrings
{
    ...
    public static readonly LocalizedStrings Ru = new()
    {
        ...
        LanguageSubmenu = "🌐 Язык / Language / Тіл",
        ...
        NotificationsToggledFormat = "[*] Всплывающие уведомления: {0}",
        NotificationsEnabled = "Включены",
        NotificationsDisabled = "Отключены",

        LogWindowTitle = "PingArmor - Журнал событий и статус",
        Clear = "Очистить",
        LogOpened = "[*] Журнал открыт. Текущий статус активен.",

        StartupTaskSuccess = "[+] Автозапуск через Task Scheduler успешно включен.",
        StartupTaskFail = "[-] Ошибка включения автозапуска.",
        StartupTaskRemoveSuccess = "[*] Автозапуск отключен.",
        StartupTaskRemoveFail = "[-] Ошибка отключения автозапуска.",
    ...
    public static readonly LocalizedStrings En = new()
    {
        ...
        LanguageSubmenu = "🌐 Language / Язык / Тіл",
        EventLog = "📋 Event log",
    ...
    public static readonly LocalizedStrings Kk = new()
    {
        ...
        LanguageSubmenu = "🌐 Тіл / Language / Язык",
        ...
        NotificationsToggledFormat = "[*] Қалқымалы хабарландырулар: {0}",
        NotificationsEnabled = "Қосулы",
        NotificationsDisabled = "Өшірулі",

        LogWindowTitle = "PingArmor - Оқиғалар журналы және күйі",
        Clear = "Тазарту",
        LogOpened = "[*] Журнал ашылды. Ағымдағы күй белсенді.",

        StartupTaskSuccess = "[+] Task Scheduler арқылы автоіске қосу сәтті қосылды.",
        StartupTaskFail = "[-] Автоіске қосуды қосу қатесі.",
        StartupTaskRemoveSuccess = "[*] Автоіске қосу өшірілді.",
        StartupTaskRemoveFail = "[-] Автоіске қосуды өшіру қатесі.",
